...
//
// Miroir de backend/src/lib/businessDays.ts : le serveur reste la source de
// vérité (il recalcule les jours à la création), cette copie ne sert qu'à
// afficher le décompte en direct dans le formulaire et à colorer le calendrier.
// Toute correction doit être reportée des deux côtés.
//
// Les dates circulent en 'YYYY-MM-DD' partout (l'API sérialise les DATE telles
// quelles). On raisonne donc en UTC : construire un Date local décalerait le jour
